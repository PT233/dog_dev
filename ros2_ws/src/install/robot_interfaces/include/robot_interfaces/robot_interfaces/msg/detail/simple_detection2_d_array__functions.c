...
robot_interfaces__msg__SimpleDetection2DArray__init(robot_interfaces__msg__SimpleDetection2DArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    robot_interfaces__msg__SimpleDetection2DArray__fini(msg);
    return false;
  }
  // detections
  if (!robot_interfaces__msg__SimpleDetection__Sequence__init(&msg->detections, 0)) {
    robot_interfaces__msg__SimpleDetection2DArray__fini(msg);
    return false;
  }
  return true;
...
robot_interfaces__msg__SimpleDetection2DArray__fini(robot_interfaces__msg__SimpleDetection2DArray * msg)
{
  ...
  // detections
  robot_interfaces__msg__SimpleDetection__Sequence__fini(&msg->detections);
}
...
robot_interfaces__msg__SimpleDetection2DArray__are_equal(const robot_interfaces__msg__SimpleDetection2DArray * lhs, const robot_interfaces__msg__SimpleDetection2DArray * rhs)
{
  ...
  // detections
  if (!robot_interfaces__msg__SimpleDetection__Sequence__are_equal(
  ...
  robot_interfaces__msg__SimpleDetection2DArray * output)
{
  ...
  // detections
  if (!robot_interfaces__msg__SimpleDetection__Sequence__copy(
...
robot_interfaces__msg__SimpleDetection2DArray__create(void)
{
  ...
  robot_interfaces__msg__SimpleDetection2DArray * msg = (robot_interfaces__msg__SimpleDetection2DArray *)allocator.allocate(sizeof(robot_interfaces__msg__SimpleDetection2DArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_interfaces__msg__SimpleDetection2DArray));
  bool success = robot_interfaces__msg__SimpleDetection2DArray__init(msg);
  if (!success) {
...
robot_interfaces__msg__SimpleDetection2DArray__Sequence__init(robot_interfaces__msg__SimpleDetection2DArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__SimpleDetection2DArray * data = NULL;

  if (size) {
    data = (robot_interfaces__msg__SimpleDetection2DArray *)allocator.zero_allocate(size, sizeof(robot_interfaces__msg__SimpleDetection2DArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_interfaces__msg__SimpleDetection2DArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robot_interfaces__msg__SimpleDetection2DArray__fini(&data[i - 1]);
      }
...
robot_interfaces__msg__SimpleDetection2DArray__Sequence__fini(robot_interfaces__msg__SimpleDetection2DArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_interfaces__msg__SimpleDetection2DArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_interfaces__msg__SimpleDetection2DArray__Sequence * array = (robot_interfaces__msg__SimpleDetection2DArray__Sequence *)allocator.allocate(sizeof(robot_interfaces__msg__SimpleDetection2DArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_interfaces__msg__SimpleDetection2DArray__Sequence__init(array, size);
  if (!success) {
...
robot_interfaces__msg__SimpleDetection2DArray__Sequence__destroy(robot_interfaces__msg__SimpleDetection2DArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_interfaces__msg__SimpleDetection2DArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_interfaces__msg__SimpleDetection2DArray__Sequence__are_equal(const robot_interfaces__msg__SimpleDetection2DArray__Sequence * lhs, const robot_interfaces__msg__SimpleDetection2DArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_interfaces__msg__SimpleDetection2DArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_interfaces__msg__SimpleDetection2DArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_interfaces__msg__SimpleDetection2DArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_interfaces__msg__SimpleDetection2DArray * data =
      (robot_interfaces__msg__SimpleDetection2DArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_interfaces__msg__SimpleDetection2DArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_interfaces__msg__SimpleDetection2DArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_interfaces__msg__SimpleDetection2DArray__copy(
