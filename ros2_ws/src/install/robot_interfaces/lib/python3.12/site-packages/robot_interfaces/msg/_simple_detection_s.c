...
bool robot_interfaces__msg__simple_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._simple_detection.SimpleDetection", full_classname_dest, 54) == 0);
  }
  robot_interfaces__msg__SimpleDetection * ros_message = _ros_message;
  {  // center_x
...
{
  /* NOTE(esteve): Call constructor of SimpleDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._simple_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SimpleDetection");
